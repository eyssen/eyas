...
[wa'DIch rep](/docs/tlh/first-hour/) rInDI' wa'logh yIlaD. veb pa' mu' DaSovbe'chugh yIchegh. yaj qech 'oH pa'vam'e', qach Hoch Del 'oHbe'.
...
| **jup** | potlh pagh ghom ghoqwI' bIjatlh — home thread, SOUL. lIng cha' chenmoH (jIH QaHwI' + pat QanwI'). | 'em tlhegh **juppu'** / ghoqwI'pu' |
| **laHwI'** | nIH QapwI' tetlh; jup Hoch chu'bogh laHwI' chenmoHlaH (`run_specialist`) | ghoqwI'pu' (patlh: laHwI') |
...
3. **janmey/laHmey** lo'laH jup, **qawHaq** ghItlhlaH, **handoff / laHwI'**, pagh **He**Daq jang
...
| **toDpa' markdown** | lIng / ghoqwI'pu' / SoH / **ja'chuq mIw rInDI' autom qon** (0.8.16-betavo' motlh chu'lu') | tIq QIj 'ej tIgh ghItlhHommey |
| **Sov pa'** | SoH (choHwI') | wIvlu'bogh wiki |
| **ghItlhmey** | lIng | PDF, Qu' teDwI'mey, mo' ngaS |

ja'Daq Dajatlhpu'bogh taH De' vault ghItlhHom mojlaH, pagh tlhoblu'. jang noblu'DI' qon Qap; qon Qapbe'chugh ghItlhHom Hutlh, jang Hutlhbe'. De': [qawHaq](/docs/tlh/knowledge/memory/).
...
| SeHwI' | QIj |
|--------|-----|
| **pat** | 'Iv pat jang: ngaQlu'bogh pat, autom He, pagh jup motlh |
| **vum** | Qub chIl vs Huch/nom. ja'chuq pat nobbogh patlhmey neH tetlh; **Auto** Suq (Deep → Max, jup vum, nobbogh ja'chuq vum) pagh pat motlh lo' |
| **ghom SeH: nIH** | laHwI'pu', handoffmey, ghom chupmey pagh |
| **ghom SeH: autom** | pat He law' wuq |
| **ghom SeH: chIl** | HoS ghom ghoqwI' He law'; motlh vum Max |
