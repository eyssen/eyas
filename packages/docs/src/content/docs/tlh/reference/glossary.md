...
| qawHaq 'ay' | juvlu'bogh boq QIn (ghom/ghoqwI'/ghom/Qap) — ghoqwI'pu' janmey lo'taHvIS laD/ghItlh |
...
| vum paqmey | ponglu'bogh paq (pong + naQ He) ja'chuq laD/ghItlhlaH; wa'DIch primary cwd. Segh pagh Qu'; ja'chuq jeS. teDwI' janmey naDev ngaQ |
| nab wa'DIch | ghItlhwI' mIw: pat nab ghItlh 'ej **chaw'** / **nab yISkip** / **lajbe'** loS, jan pa' |
| Skill import roots | pat `skills.importRoots` / `agent.importRoots` `local.yaml`Daq. motlh chIm. Hop taH |
...
| CASL | chaw' paq |
| Qu' SeH | Solo/Auto/Deep bIH ghoqwI' chut (God Mode je) |
| vum 'ab | qech 'ab SeH |
