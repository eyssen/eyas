...
cha' mIw tetlh **rarbogh latlh vum** qawHaq, wanI' qawHaq, 'ej latlh ja'chuq
QInmeyDaq tu' — DaH QIn 'oH nej. ghoqwI' `search_memory` ra'nISbe' 'e'
narghmeH. porghmey `search_memory` lo'taHvIS laDlu' taH. latlh QInmey
nejlaHlu' qonlu'ta'mo'; cha'bogh qon 'oHbe'.
