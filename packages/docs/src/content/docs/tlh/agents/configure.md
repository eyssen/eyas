...
| De' | QIj |
|-----|-----|
| **patlh** | potlh / ghom = juppu' bIjatlh; laHwI' = tetlh chenmoH ([Del](/docs/tlh/agents/overview/) yIbej) |
...
**jIH QaHwI'** SeH — `write_file` / `edit_file` / `run_command` yInobQo'. **pat QanwI'** 'ej ghItlh laHwI'pu' janmeyvetlh ghaj. [ghommey Segh je](/docs/tlh/agents/teams/) yIlegh.
