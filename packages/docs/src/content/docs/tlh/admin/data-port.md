...
- ngo' latlh jan qawHaq DaSIchpu' DaHjaj — Claude Code laDbogh qach `CLAUDE.md`, `~/.claude` qoDDaq tlhap Sor, Memory / Qdrant / Obsidian MCP De'wI' — 'ej DaH lajQo' EYAS. tlhap 'oH chaw'lu'bogh 'elmeH He'e': wa' He neH, wa'logh, Hal qonlu'.
...
| chelmoH | **motlh chu'Ha'lu'** — wIvlaHbogh per, De' De' neH (Segh, Dov, permey, chovlu'bogh rarmey), porgh not; chelmoHlu'bogh ghItlhHommey 'Iv jang ja' (`enriched_by`) |
...
**motlh chu'Ha'lu' mIw DubwI'.** legh mIwDaq **mIw DubwI' lo' — De' De' neH** per tu'lu'. wIvbe'lu'chugh — motlh — tlhap naQ nIteb qaS, 'ej pagh mIw ja'lu'; tlhapmeyvamvaD pagh choH. wIvlu'chugh, Segh Delbe'bogh ghItlhHommey Segh chup, Dov, permey, rarmey je Suq EYAS **'em pat**vo': wa'DIch Heartbeat He patlh, ghIq lIng motlh, ghIq API nobwI'pu', ghIq nIteb QaplaHbogh CLImey. Dochmey 'aqroS tu'be'; poH neH Dil. porgh not qa'moHlu', mIw jatlhmo' pagh chIllu', 'ej `contains-secrets` per ghajbogh Doch not ngeHlu'. Doch tetlh 'ang: arlogh ghItlhHommey chelmoHlu'.

- **nIteb jang neH lo'lu'.** nIteb ra' (wa' mIw, jan pagh) lo'taHvIS 'em patvo' jang ghoSDI' neH lo'lu': API nobwI', pagh nIteb QaplaHbogh CLI. pat rurvetlh lo'laHbe'lu'chugh (Grok neH pagh Kimi neH lIng rur), ra' lujchugh pagh chIm jangchugh, pagh lajQo'chugh pat, nIteb De' De'Daj neH pol ghItlhHom 'ej Doch tetlhDaq **Qav mIw** rur toghlu'.
- **rarmey chovlu'.** pat chupbogh rar pollu' vault Daq tu'lu'bogh ghItlhHom pongDI' neH (teywI' pong pagh per) pagh tlhapvamDaq wIvlu'bogh ghItlhHom pongDI' neH, 'ej ghItlhHomvetlh teywI' pong rur ghItlhlu'. pat chupbogh latlh rar Hoch chIllu'. Hal teywI''egh ngaSbogh rarmey reH choHbe'lu' pollu'.
- **chelmoHlu'bogh ghItlhHommey 'Iv jang ja'.** chelmoHlu'bogh Hoch ghItlhHom frontmatterDaq `enriched_by` Doch ghaj, `enriched_by: {provider: anthropic, model: claude-haiku-4-5, route: tier}` rur. `provider` — jangbogh nobwI'; `model` — ja'bogh pat, pat ponglu'be'DI' chIllu' (motlh patDaj lo'bogh CLI); `route` — chay' 'em pat wIvlu' — `tier` (He patlh, wa'DIch Heartbeat), `default` (lIng motlh), `api` (API nobwI'), pagh `isolated-cli` (nIteb QaplaHbogh CLI). ghIq ghItlhHom ghItlhqa'lu'DI' Doch ratlh. chelmoH Hutlh tlhaplu'bogh ghItlhHommey `enriched_by` ghajbe'.
- Qu' QapDI' 'em pat nejlu', De'wI' taghDI' ghobe', vaj Data Port ret pat 'ay' lo'laHchoHDI' je chelmoH Qap.

**ngo' chelmoHlu'bogh tlhap Say'moH.** chu'choHvampa' chelmoHlu'bogh tlhapmey `enriched_by` ghajbe' 'ej chovbe'lu'pu'bogh rarmey ngaSlaH. chelmoH Hutlh DaqaSqa'moHmeH: Doch tetlhDaq pagh *tlhap ret* tetlhDaq Qu' yIpoSmoH 'ej **tlhapvam yIcheghmoH** yIwIv, ghIq Hal rap yInejqa' 'ej **mIw DubwI' lo' — De' De' neH** wIvbe'taHvIS yItlhap. ret porghDaj DachoHpu'bogh ghItlhHommey pollu' 'ej *skipped* rur ja'lu'.
...
latlh jan pa'mey laD tlhapwI''egh, pat jan lo'be', vaj Hub lojmIt qawHaq chut choHbe' — **Hoch pat** `~/.claude`, `~/.grok`, `ai-memory` pa'mey, Obsidian vaultmey, latlh je laDmeH ghItlhmeH lajQo'bogh chut ([Hub 'ej pegh — EYAS Hur qawHaq](/docs/tlh/admin/security-privacy/#memory-outside-eyas)). ngo' teywI'vetlh laDbogh ghoqwI' DaH lajQo'lu'; naDev wa'logh De' yItlhap. [qawHaq](/docs/tlh/knowledge/memory/) yIlegh.

**DaH EYAS laDbe'bogh De'vaD 'elmeH He 'oH:**

- **qach `CLAUDE.md` qach laHmey je.** reH nIteb Qap Claude Code 'ej DaH laDbe'; naDev wa'logh yItlhap. [nobwI'pu' — Claude Code nIteb](/docs/tlh/ai/providers/#claude-code-isolation).
- **latlh jan pa'mey qoDDaq tlhap Sormey.** `~/.claude`, `~/.grok`, `~/.agents`, Obsidian vault qoDDaq `skills.importRoots` / `agent.importRoots` Dochmey taghDI' buSHa'lu'; pa'vetlh naDev wa'logh yItlhap, ghIq `local.yaml`vo' Doch yIteq. [SeH](/docs/tlh/deploy/configuration/#extra-skill-and-persona-roots).
- **qawHaq pa' MCP De'wI'mey.** Memory, Qdrant, Obsidian, MCPVault MCP De'wI'mey, 'ej vault pagh latlh jan qawHaq 'oSbogh Hoch De'wI' — Hoch patvaD botlu'; naDev qawHaqvetlh EYASDaq yIqonqa'. [MCP](/docs/tlh/ai/mcp/#memory-store-servers-are-blocked).
- **teqlu'bogh tlhaplu'bogh ghoqwI'pu'.** `agent.importRoots`vo' tlhaplu'bogh ghoqwI' Dateqpu'bogh taghDI' chenmoHqa'be'lu'; DacheghmoHmeH, teywI'Daj naDev yItlhap.
...
**nuq ta' per.** `contains-secrets` ghajbogh ghItlhHom, wanI' tlhegh, pagh laH: nIteb SIchbogh mIw Hoch vo' So'lu' — taHbogh qawHaq tetlh, qawqa', `search_memory`, qelwI' Qu', ram Sepmey boqmoHwI', laH lanwI', 'ej chenmoHlu'bogh pat ra'mey. chaw'lu'bogh mIw DubwI'vaD not nob, 'ej not lanlu'. Dochvo' EYAS chenmoHbogh Hoch per Suq je — tetlh tlholDaq cha'DIch qonDaj, Dochvo' tu'lu'bogh vItmey, Dochvo' chenmoHlu'bogh Dovmey — vaj patDaq ghoSbe' chaH je ([qawHaq — tlhaplu'bogh peghmey qawqa' vo' ratlh](/docs/tlh/knowledge/memory/#imported-secrets-stay-out-of-recall)). qawHaq HaqDaq naQ Dalegh taH. mIwvaD DapoSmoHmeH, `config/local.yaml`Daq `memory.recall.includeSecrets: true` yIcher 'ej yItaghqa' — [cher](/docs/tlh/deploy/configuration/) yIlegh.
...
| **mIw DubwI' lo' — De' De' neH** | motlh chu'Ha'lu' — wIvlaH, De' De' neH (Segh, Dov, permey, tu'lu'bogh ghItlhHommeyDaq rarmey), porgh not, perlu'bogh Doch not; nIteb 'em pat jang neH lo'lu', pagh Qav mIw rur toghlu' |
