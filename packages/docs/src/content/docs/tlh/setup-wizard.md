...
**meq.** wa'DIch tagh neH. pIn'a' potlh pegh mu', potlh pIn, cha' potlh ghoqwI'pu', wa'DIch pat 'emDaq je chenmoHmeH potlh Qu' poSmoH. ghIq **SeHmey**, **nobwI'pu'**, **ghoqwI'pu'** bIngDaq choH — pIn'a' DapeltaHqa' 'e' yIHonbe'.

## nuqDaq yIlo'

- qunI'wI' `/setup`Daq ngeH SoH, lIng rInbe'mo'
- poQbe' mIw Darghpu' 'ej De' tetlh DaneH
- chu' pat Dachenqa'

potlh Qu' poSDI' jajvam choHvaD lo'be'.
...
**meq:** cha' reH Qapbogh **juppu'** bIjatlh ('em tlhegh **juppu'**, jup HochvaD wa' home thread).
...
ghIq **ghoqwI'pu'** bIngDaq pongchoHlaH 'ej SeHchoHlaH. pIn'a' rInDI' 'em tlhegh **juppu'** tetlhDaq yIpoS. QaHwI' SeH, ngogh choHbe'; QanwI' pat/ngogh ghaj. [ghommey Segh je](/docs/tlh/agents/teams/) yIlegh.

---

## ghom ghoqwI'pu' (poQbe')

**meq:** latlh **juppu'** (ghom patlh) 'ej **laHwI'pu'** (tetlh; jup Hoch chenmoHlaH). potlh ghoqwI'pu' chup chaw' poQbe' chu'bogh laHwI'vaD.
...
| ghoS | meq |
|------|-----|
| [wa'DIch rep](/docs/tlh/first-hour/) | yIntaHbogh UI: jIH Daq, wa' ja'chuq, Qu' nav, qawHaq |
...
| [ghoqwI'pu'](/docs/tlh/agents/overview/) | juppu' 'ej laHwI'pu' tIchov |
| [ghommey Segh je](/docs/tlh/agents/teams/) | handoff 'ej `run_specialist` |
