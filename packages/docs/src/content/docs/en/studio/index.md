...
**What this is for.** Studio is where EYAS runs **local production engines** — tools that take something the agent wrote (HTML, an EDL) and render a file on this machine. Engines: Hyperframes (HTML→MP4) and Video Use (footage→MP4). [Media](/docs/en/ai/media/) is the other lane: hosted prompt→pixels (Magnific, Higgsfield, fal, HeyGen). Do not mix them.
