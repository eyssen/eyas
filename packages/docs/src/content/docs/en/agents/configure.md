...
The **Personal Assistant** (primary, type assistant) is a coordinator — do not give it `write_file` / `edit_file` / `run_command`. The **System Engineer** and coding specialists own those tools. See [Teams & delegation](/docs/en/agents/teams/).
