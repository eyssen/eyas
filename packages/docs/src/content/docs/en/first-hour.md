...
In the sidebar, under **Colleagues**, click the **Personal Assistant** (day-to-day) or the **System Engineer** (EYAS itself). That opens their **home thread** — one continuous conversation per colleague. They stay; task threads come and go.

Ask the Assistant something that is not code. It should hand off or spawn a specialist rather than edit files itself. The **Agents** list (`/agents`) is the roster (Primary and Team = colleagues you talk to; Specialist = workers they spawn). See [Teams & delegation](/docs/en/agents/teams/).
...
- [Teams & delegation](/docs/en/agents/teams/) — colleagues, specialists, home threads
