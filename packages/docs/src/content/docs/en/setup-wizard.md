...
**Purpose:** create the two always-on **colleagues** you talk to (sidebar **Colleagues**, one home thread each).
...
You can rename and reconfigure them later under **Agents**. Open them from the sidebar **Colleagues** list after the wizard. The Assistant coordinates and does not edit source; the Engineer owns platform/code. See [Teams & delegation](/docs/en/agents/teams/).
