...
| OpenCode terminál | Csak a tulajdonosé és az adminoké (az OpenCode kezelési joga): a terminál a szerver saját felhasználójaként futtat parancsokat. A user szerepkör látja az OpenCode oldalt, és a kollégák `opencode_run` feladatai futnak a beszélgetéseiben. A beépített szerepkörök jogai rögzítettek; ha valakinek terminál kell, add neki az admin szerepkört. Ha valakinek a szerepkörét lejjebb veszed, felfüggeszted vagy archiválod, a nyitott termináljai azonnal leállnak — lásd [OpenCode — Ki nyithat terminált](/docs/hu/automation/opencode/#who-can-open-a-terminal) |
