...
Az AI-szerkesztés a telepítés alapértelmezett modelljén fut: a **Standard**
routing-szinten, különben az alapértelmezett provideren, különben az első aktív
provideren (ábécérendben), amelynek van engedélyezett modellje. Egyetlen izolált,
tool nélküli hívásként fut. Hogy melyik provider regisztrált elsőként, az már
nem számít.
