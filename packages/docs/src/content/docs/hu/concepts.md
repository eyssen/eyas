...
| **Kolléga** | Primary vagy team agent, akivel beszélsz — home-szál, SOUL. A setup kettőt hoz (Személyi asszisztens + Rendszermérnök). | Sidebar **Kollégák** / Agentek |
| **Specialista** | Szűk munkás a közös poolból; bármelyik kolléga indíthat enabledet (`run_specialist`) | Agentek (Specialista) |
...
3. Kolléga: **tool/skill**, **memória**, **handoff / specialista**, **csatorna**
...
| Vezérlő | Jelentés |
|---------|----------|
| **Modell** | Melyik modell válaszol: rögzített modell, Auto-routing, vagy a kolléga alapértelmezése |
| **Effort** | Gondolkodási mélység vs költség/sebesség. Csak a beszélgetés modellje által kínált szinteket listázza; az **Auto** örököl (Deep → Max, a kolléga effortja, a delegáló beszélgetésé), vagy a modell alapértelmezését használja |
| **Solo** | Nincsenek specialisták, átadások és csapatjavaslatok |
| **Auto** | A modell dönt a fan-out-ról |
| **Deep** | Agresszív többágenses fan-out; alapértelmezett effort: Max |
