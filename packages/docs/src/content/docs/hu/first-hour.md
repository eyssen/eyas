...
Figyeld a streamet: **Gondolkodik** vagy **Gondolkodik…**, aztán **Válasz készítése…** vagy **Eszközök futnak…**. A tool-sorok mutatják a tool-id-t, a rövid argumentumot és az eredményt futás közben — fájlszerkesztésnél **Diff**. A **Leállítás** megszakítja a futást. A composer térkép ikonja az **Először terv**, ha toolok előtt tervet akarsz.
...
A sidebar **Kollégák** listáján nyisd a **Személyi asszisztenst** (napi munka) vagy a **Rendszermérnököt** (maga az EYAS). Ez a **home-száluk** — kollégánként egy folytonos beszélgetés. Ők maradnak; a feladat-szálak jönnek-mennek.

Kérj az Asszisztenstől valamit, ami nem kód. Át kell adnia vagy specialistát indítania, nem fájlt szerkesztenie. Az **Agentek** lista (`/agents`) a roster (Primary és Team = kollégák; Specialist = akiket ők indítanak). Lásd [Csapatok és delegálás](/docs/hu/agents/teams/).
...
- [Csapatok és delegálás](/docs/hu/agents/teams/) — kollégák, specialisták, home-szál
