...
A **context %** azt mutatja, mennyire telt meg a modell kontextusablaka — ugyanaz a mérés, mint a beszélgetés kontextussávjánál: ahol elérhető, a provider által az utolsó modellhívásra jelentett promptméret, különben becslés (rendszerprompt plusz előzmények), a válaszoló modell saját ablakához mérve. A színek a témát követik.
