...
| Coding surface | Model-független file toolok (`read_file`, `edit_file`, …) az EYAS-ban |
| Worktree | Izolált git working tree párhuzamos team agentnek |
...
| Connection | Névvel ellátott külső rendszer leltár (Odoo, GitHub, MCP, …) |
| Csatorna | Külső üzenetküldő connector |
