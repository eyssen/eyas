...
**Mire való.** A Stúdióban futnak a **helyi gyártómotorok** — az ügynök ír valamit (HTML, kompozíció), a gép fájlt renderel. Az első motor a Hyperframes. A [Média](/docs/hu/ai/media/) a másik sáv: hosted prompt→pixel (Magnific, Higgsfield, fal, HeyGen). Ne keverd.
