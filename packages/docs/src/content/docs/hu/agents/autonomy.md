...
2. Az approvalok a Dashboard **Needs attention**, a beszélgetés **Waiting approval** és Telegramon **Approve / Deny** alatt jelennek meg (ugyanaz a decide-út; nincs nyers tool-arg).  
