...
| Mező | Jelentés |
|------|----------|
| **Tier** | Primary / Team = kollégák, akikkel beszélsz; Specialist = közös pool ([áttekintés](/docs/hu/agents/overview/)) |
...
toolokat. A **Személyi asszisztens** koordinál — ne kapjon `write_file` / `edit_file` / `run_command` toolokat. A **Rendszermérnök** és a kódoló specialisták viselik ezeket. Lásd [Csapatok és delegálás](/docs/hu/agents/teams/). A 0.8.6 előtti agentek **nem** kapják automatikusan — itt kell bővíteni.
