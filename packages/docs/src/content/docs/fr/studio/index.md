...
**À quoi ça sert.** Studio fait tourner des **moteurs de production locaux** : l’agent écrit du HTML, cette machine rend un fichier. Premier moteur : Hyperframes. [Media](/docs/fr/ai/media/) est l’autre voie : prompt→pixels (Magnific, Higgsfield, fal, HeyGen). Ne pas mélanger.
