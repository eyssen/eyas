...
2. Les approbations apparaissent sous Tableau de bord **Nécessite votre attention**, conversation **En attente d'approbation**, et Telegram **Approve / Deny** (même chemin decide, sans arguments bruts).  
