...
|--------|---------------|
| **Principal** | Collègues à qui vous parlez (coéquipiers de l’installation) |
| **Équipe** | Collègues à qui vous parlez (rôles permanents) |
| **Spécialiste** | Travailleurs étroits qu’un collègue peut lancer |
