...
Magnific, Higgsfield, fal et HeyGen se branchent sous [Médias](/docs/fr/ai/media/) ; l’agent utilise cinq outils `media_*` au lieu des catalogues MCP bruts du vendeur.
