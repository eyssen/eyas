...
Observez le flux : **Réflexion** ou **Réflexion…**, puis **Rédaction de la réponse…**. Si l’agent appelle un outil, dépliez **Entrée** / **Sortie** (ou **Erreur**). **Arrêter** annule l’exécution.
