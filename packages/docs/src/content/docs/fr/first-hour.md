...
Dans la barre, sous **Collègues**, ouvrez l’**Assistant personnel** (le quotidien) ou l’**Ingénieur système** (EYAS lui-même). Cela ouvre leur **fil d’accueil** — une conversation continue par collègue. Ils restent ; les fils de tâche vont et viennent.

Demandez à l’Assistant quelque chose qui n’est pas du code. Il doit passer la main ou lancer un spécialiste, pas éditer des fichiers. La liste **Agents** (`/agents`) est le roster. Voir [Équipes et délégation](/docs/fr/agents/teams/).
...
- [Équipes et délégation](/docs/fr/agents/teams/) — collègues, spécialistes, fils d’accueil
