...
3. Ayez une conversation de plus de ~40 caractères qui énonce un fait durable. Revenez ici après la réponse : une nouvelle note (`user`, `feedback`, `project` ou `reference`).
...
| **Wiki client** | Notes de livraison d’un client, pas la mémoire globale. |
...
- [Wiki client](/docs/fr/knowledge/client-wiki/)
