...
| Modules | Projets, Documents, Sources de recherche, Notifications, Proactif, Auto-apprentissage, Extensions |
| Intégrations | [Connexions](/docs/fr/admin/connections/) (`/connections`) — inventaire des systèmes externes |
| Infrastructure | Hands, [Ingress](/docs/fr/admin/ingress/), Nœuds, Sauvegarde, Réunions |
