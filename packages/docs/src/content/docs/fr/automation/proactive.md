...
Traitez-les comme des surfaces d’attention pour l’opérateur — combinez-les avec la priorité du Tableau et les recommandations de configuration du [Tableau de bord](/docs/fr/daily/dashboard/).
