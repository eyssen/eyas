...
Feature-Flags (standard **aus**): Heartbeat, Reflection/Briefing, Forge, Self-Learning, Identity self-update. YAML: `autonomy.identitySelfUpdate`. Approvals auch unter Start **Braucht Aufmerksamkeit**, Gespräch **Waiting approval**, und Telegram **Approve / Deny** (dieselbe decide-Strecke, keine rohen Args).
