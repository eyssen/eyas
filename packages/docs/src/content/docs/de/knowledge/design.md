---
title: "Design-Canvas"
description: "UI-, Landing-, Print- oder Deck-Zeichenflächen — dann an Gespräch oder Projekt hängen."
---
...
Eine KI-Bearbeitung läuft auf dem Standardmodell der Installation: der
**Standard**-Routing-Stufe, sonst dem Default-Anbieter, sonst dem ersten aktiven
Anbieter (alphabetisch) mit einem aktivierten Modell. Sie läuft als ein isolierter
Aufruf ohne Werkzeuge. Welcher Anbieter sich zuerst registriert hat, spielt keine
Rolle mehr.
