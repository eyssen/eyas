...
3. Führe ein Gespräch länger als ~40 Zeichen, das einen bleibenden Fakt nennt. Nach der Antwort hierher — eine neue Vault-Notiz (`user`, `feedback`, `project` oder `reference`).
...
| **Kunden-Wiki** | Delivery-Notizen eines Kunden, nicht globaler Speicher. |
...
- [Kunden-Wiki](/docs/de/knowledge/client-wiki/)
