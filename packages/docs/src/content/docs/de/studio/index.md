...
**Wozu.** Studio betreibt **lokale Production-Engines** — der Agent schreibt HTML, diese Maschine rendert eine Datei. Erste Engine: Hyperframes. [Media](/docs/de/ai/media/) ist die andere Spur: Prompt→Pixel (Magnific, Higgsfield, fal, HeyGen). Nicht mischen.
