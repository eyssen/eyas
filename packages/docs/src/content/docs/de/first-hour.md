...
In der Sidebar unter **Kollegen** klicke den **Personal Assistant** (Alltag) oder den **System Engineer** (EYAS selbst). Das öffnet ihren **Home-Thread** — ein fortlaufendes Gespräch pro Kollege. Sie bleiben; Aufgaben-Threads kommen und gehen.

Bitte den Assistant um etwas, das kein Code ist. Er soll übergeben oder einen Spezialisten starten, nicht selbst Dateien editieren. Die **Agenten**-Liste (`/agents`) ist der Roster. Siehe [Teams und Delegation](/docs/de/agents/teams/).
...
- [Teams und Delegation](/docs/de/agents/teams/) — Kollegen, Spezialisten, Home-Threads
