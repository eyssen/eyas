...
Beobachte den Stream: **Denkt nach** oder **Denkt nach…**, dann **Antwort wird verfasst…**. Ruft der Agent ein Tool auf, klappe **Eingabe** / **Ausgabe** (oder **Fehler**) auf. **Stopp** bricht den Lauf ab.
