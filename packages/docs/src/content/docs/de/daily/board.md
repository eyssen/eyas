...
**Context %** zeigt, wie voll das Kontextfenster des Modells ist — dieselbe Messung wie die Kontextleiste des Gesprächs: die Prompt-Größe, die der Anbieter für den letzten Modellaufruf gemeldet hat, wo verfügbar, sonst eine Schätzung (System-Prompt plus Verlauf), gemessen am eigenen Fenster des antwortenden Modells. Die Farben folgen dem Theme.
