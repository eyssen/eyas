...
Reihenfolge bei gleicher Id — nie Dateisystemreihenfolge: **User > Generated > Bundled (Extension) > Bundled (EYAS)**; Gleichstand alphabetisch nach Wurzel, dann Pfad. Verlierer stehen unter **Überschattet**.
