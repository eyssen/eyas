...
- Ein Projekttyp soll ein vererbbares Brief tragen (Formular = was das Modell sieht; leer erbt der Typ, `+` erweitert, sonst Override; Speichern schreibt `AGENTS.md`).
