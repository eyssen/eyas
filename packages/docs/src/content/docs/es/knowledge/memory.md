...
3. Ten una conversación de más de ~40 caracteres que enuncie un hecho duradero. Vuelve aquí tras la respuesta: una nota nueva (`user`, `feedback`, `project` o `reference`).
...
| **Wiki de cliente** | Notas de delivery de un cliente, no memoria global. |
...
- [Wiki de cliente](/docs/es/knowledge/client-wiki/)
