...
Observa el stream: **Pensando** o **Pensando…**, luego **Redactando respuesta…**. Si el agente llama a una herramienta, despliega **Entrada** / **Salida** (o **Error**). **Detener** cancela la ejecución.
