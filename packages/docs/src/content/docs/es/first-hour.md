...
En la barra, bajo **Colegas**, abre el **Asistente personal** (el día a día) o el **Ingeniero de sistema** (el propio EYAS). Eso abre su **hilo de inicio** — una conversación continua por colega. Ellos se quedan; los hilos de tarea van y vienen.

Pide al Asistente algo que no sea código. Debe ceder o lanzar un especialista, no editar archivos. La lista **Agentes** (`/agents`) es el roster. Véase [Equipos y delegación](/docs/es/agents/teams/).
...
- [Equipos y delegación](/docs/es/agents/teams/) — colegas, especialistas, hilos de inicio
