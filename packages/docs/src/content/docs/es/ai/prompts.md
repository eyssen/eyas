...
- Un tipo de proyecto debe llevar un brief heredable (el formulario es lo que ve el modelo; vacío hereda el tipo, `+` amplía, cualquier otra cosa sustituye; guardar escribe `AGENTS.md`).
