...
Magnific, Higgsfield, fal y HeyGen se conectan en [Media](/docs/es/ai/media/); el agente usa cinco herramientas `media_*` en vez de los catálogos MCP crudos del vendor.
