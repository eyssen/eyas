...
3. **Agentes primarios** — los dos **colegas** always-on (Asistente personal + Ingeniero de sistema)  
4. **Agentes de equipo** (opcional) — más colegas y especialistas del pool compartido  
...
**Para qué:** los dos **colegas** always-on con los que hablas (barra **Colegas**, un hilo de inicio cada uno).
...
Cada uno: fila DB + workspace `data/agents/<id>/` + usuario agent. Ábrelos en **Colegas** después del asistente. El Asistente coordina y no edita código fuente; el Ingeniero posee plataforma/código. Véase [Equipos y delegación](/docs/es/agents/teams/).

### Equipo (opcional)

**Para qué:** más **colegas** (nivel team) y **especialistas** (pool compartido). Los primarios no necesitan tarjeta de propuesta para llamar a un especialista activo.
...
- [Inicio](/docs/es/daily/home/) · [Proveedores](/docs/es/ai/providers/) · [Agentes](/docs/es/agents/overview/) · [Equipos y delegación](/docs/es/agents/teams/)
