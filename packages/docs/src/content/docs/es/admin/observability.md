...
| Ops | `/ops` | Agente ops de Kubernetes — observar → diagnosticar → proponer → aprobar → aplicar. Por defecto **solo proponer**. URL del clúster, kubeconfig y repo GitOps son config de instancia. |
