...
Flags (off por defecto): heartbeat, reflection, Forge, self-learning, identity self-update. YAML: `autonomy.identitySelfUpdate`. Aprobaciones también en Inicio, en la conversación y en Telegram **Approve / Deny** (misma ruta decide, sin args crudos).
