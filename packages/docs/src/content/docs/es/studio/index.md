...
**Para qué.** Estudio ejecuta **motores de producción locales**: el agente escribe HTML y esta máquina genera un archivo. El primero es Hyperframes. [Media](/docs/es/ai/media/) es la otra vía: prompt→píxeles (Magnific, Higgsfield, fal, HeyGen). No las mezcles.
