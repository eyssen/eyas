  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        bullets: {
          en: ['CHANGELOG.md', 'CLAUDE.md', 'Contributor vs user docs'],
          hu: ['CHANGELOG.md', 'CLAUDE.md', 'Fejlesztői vs felhasználói docs'],
          de: ['CHANGELOG.md', 'CLAUDE.md', 'Contributor- vs User-Docs'],
          es: ['CHANGELOG.md', 'CLAUDE.md', 'Docs de contribuidor vs usuario'],
        },
      },
    ],
  },
