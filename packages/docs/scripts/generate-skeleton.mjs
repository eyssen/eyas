...
const SECTIONS = [
    ...
    pages: [
      ...
      },
      {
        ...
        titles: {
          ...
          de: 'Die erste Stunde',
          es: 'Tu primera hora',
          fr: 'Votre première heure',
          tlh: 'wa\'DIch rep',
        },
        descriptions: {
          en: 'A guided first hour: home, a conversation, a board card, and where memory lives.',
          hu: 'Vezetett első óra: kezdőlap, beszélgetés, táblakártya, és hol él a memória.',
          de: 'Geführte erste Stunde: Start, Gespräch, Board-Karte und wo der Speicher lebt.',
          es: 'Primera hora guiada: inicio, una conversación, una tarjeta y dónde vive la memoria.',
          fr: 'Première heure guidée : accueil, une conversation, une carte, et où vit la mémoire.',
          tlh: 'Devbogh wa\'DIch rep: jIH Daq, ja\'chuq, Qu\' nav chaw\', \'ej nuqDaq qawHaq yIn.',
        },
        bullets: {
          en: ['Open Home and read the pulse', 'Start one conversation', 'Pin the result on the Board', 'See what Memory captured', 'What to learn next'],
          hu: ['Nyisd meg a Kezdőlapot', 'Indíts egy beszélgetést', 'Rögzítsd az eredményt a Táblán', 'Nézd meg, mit kapott el a Memória', 'Mit tanulj ezután'],
          de: ['Start öffnen und den Puls lesen', 'Ein Gespräch starten', 'Ergebnis auf dem Board pinnen', 'Prüfen, was Memory erfasst hat', 'Was als Nächstes'],
          es: ['Abrir Inicio y leer el pulso', 'Empezar una conversación', 'Fijar el resultado en el Tablero', 'Ver qué capturó Memoria', 'Qué aprender después'],
          fr: ['Ouvrir l’accueil et lire le pouls', 'Démarrer une conversation', 'Épingler le résultat au tableau', 'Voir ce que la mémoire a capturé', 'Que lire ensuite'],
          tlh: ['jIH Daq yIpoS \'ej tIq yIlaD', 'wa\' ja\'chuq yItagh', 'Qu\' navDaq yIQan', 'qawHaq qon nuq yIbej', 'latlh yIHaD'],
        },
      },
      {
        slug: 'concepts',
  ...
  },
  {
    ...
    pages: [
      {
        slug: 'daily/home',
        titles: { en: 'Home', hu: 'Kezdőlap', de: 'Start', es: 'Inicio', fr: 'Accueil', tlh: 'jIH Daq' },
        descriptions: {
          en: 'Home view: widget grid, edit mode, factory layout.',
          hu: 'Kezdőnézet: widget rács, szerkesztő mód, gyári elrendezés.',
          de: 'Startansicht: Widget-Raster, Bearbeitungsmodus, Standardlayout.',
          es: 'Vista de inicio: cuadrícula de widgets, modo edición, diseño de fábrica.',
          fr: 'Vue d’accueil : grille de widgets, mode édition, disposition d’usine.',
          tlh: 'tagh jIH: widget raS, choHtaHghach, motlh raS.',
        },
        bullets: {
          en: ['Factory nine tiles', 'Edit mode: move / resize', 'Add / remove widgets', 'Restore factory layout'],
          hu: ['Gyári kilenc csempe', 'Szerkesztő mód: mozgatás / átméretezés', 'Widget hozzáadása / eltávolítása', 'Gyári elrendezés visszaállítása'],
          de: ['Neun Standardkacheln', 'Bearbeitungsmodus: verschieben / skalieren', 'Widgets hinzufügen / entfernen', 'Standardlayout wiederherstellen'],
          es: ['Nueve tarjetas de fábrica', 'Modo edición: mover / redimensionar', 'Añadir / quitar widgets', 'Restaurar diseño de fábrica'],
          fr: ['Neuf tuiles d’usine', 'Mode édition : déplacer / redimensionner', 'Ajouter / supprimer des widgets', 'Restaurer la disposition par défaut'],
          tlh: ['motlh Hutlh widget', 'choHtaHghach: vem / rat choH', 'widget chel / teq', 'motlh raS cheghmoH'],
        },
      },
      {
  ...
  },
  {
    ...
    pages: [
      ...
      {
        slug: 'automation/browser-use',
        titles: { en: 'Browser Use', hu: 'Browser Use', de: 'Browser Use', es: 'Browser Use', fr: 'Browser Use', tlh: 'weQ lo\'' },
        descriptions: {
          en: 'Optional CLI sidecar for a real, logged-in Chrome. Not the headless Playwright tools.',
          hu: 'Opcionális CLI-sidecar a belépett Chrome-hoz. Nem a headless Playwright toolok.',
          de: 'Optionaler CLI-Sidecar für eingeloggtes Chrome. Nicht die headless-Playwright-Tools.',
          es: 'Sidecar CLI opcional para Chrome con sesión. No son las herramientas Playwright headless.',
          fr: 'Sidecar CLI optionnel pour un Chrome connecté. Pas les outils Playwright headless.',
          tlh: 'CLI sidecar optional. Chrome lI\'. Playwright jan \'oHbe\'.',
        },
        bullets: {
          en: ['Three lanes (headless / logged-in Chrome / Hands)', 'Doctor checks', 'browser_use_exec', 'Telemetry off'],
          hu: ['Három sáv (headless / belépett Chrome / Kezek)', 'Doctor', 'browser_use_exec', 'Telemetria ki'],
          de: ['Drei Spuren (headless / eingeloggt / Hände)', 'Doctor', 'browser_use_exec', 'Telemetrie aus'],
          es: ['Tres carriles (headless / sesión / Manos)', 'Doctor', 'browser_use_exec', 'Telemetría off'],
          fr: ['Trois voies (headless / connecté / Mains)', 'Doctor', 'browser_use_exec', 'Télémétrie off'],
          tlh: ['wej He (headless / Chrome lI\' / ghopDu\')', 'Qel', 'browser_use_exec', 'telemetry Qoff'],
        },
      },
      {
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        titles: { en: 'Design canvases', hu: 'Design tervek', de: 'Design-Canvases', es: 'Lienzos de diseño', fr: 'Toiles de conception', tlh: 'nab tetlhmey' },
        descriptions: {
          en: 'Multi-artboard design canvases, edited by hand or by AI.',
          hu: 'Több-artboardos design tervek, kézzel vagy AI-jal szerkesztve.',
          de: 'Design-Canvases mit mehreren Artboards, von Hand oder per KI bearbeitet.',
          es: 'Lienzos de diseño con varias mesas de trabajo, editados a mano o con IA.',
          fr: "Toiles de conception à plusieurs plans de travail, modifiées à la main ou par l'IA.",
          tlh: "law' 'ay' nab tetlh, ghop pagh AI choHlu'.",
        },
        bullets: {
          en: ['Canvas and artboards', 'Editing by hand and by AI', 'Versions and restore', 'Import and export', 'Referencing a design in a conversation'],
          hu: ['Canvas és artboardok', 'Szerkesztés kézzel és AI-jal', 'Verziók és visszaállítás', 'Import és export', 'Design hivatkozása beszélgetésben'],
          de: ['Canvas und Artboards', 'Bearbeiten von Hand und per KI', 'Versionen und Wiederherstellen', 'Import und Export', 'Ein Design in einer Konversation referenzieren'],
          es: ['Lienzo y mesas de trabajo', 'Edición a mano y con IA', 'Versiones y restauración', 'Importar y exportar', 'Referenciar un diseño en una conversación'],
          fr: ['Toile et plans de travail', "Édition à la main et par l'IA", 'Versions et restauration', 'Import et export', 'Référencer un design dans une conversation'],
          tlh: ["tetlh 'ay'mey je", "ghop AI je choH", "chovnatlhmey choHqa' je", "lIH ngeH je", "ja'chuqDaq nab yIper"],
        },
      },
      {
  ...
  },
  {
    ...
    pages: [
      {
        slug: 'studio',
        titles: { en: 'Studio', hu: 'Stúdió', de: 'Studio', es: 'Estudio', fr: 'Studio', tlh: 'mIw pa\'' },
        descriptions: {
          en: 'Local engines that turn authored HTML or footage into video. Not Media.',
          hu: 'Helyi motorok, amelyek írott HTML-ből vagy nyers felvételből videót készítenek. Nem a Média.',
          de: 'Lokale Engines, die geschriebenes HTML oder Rohmaterial zu Video machen. Nicht Media.',
          es: 'Motores locales que convierten HTML o metraje en vídeo. No es Media.',
          fr: 'Moteurs locaux qui transforment du HTML ou des rushes en vidéo. Pas Media.',
          tlh: 'HTML qonlu\'bogh pagh video pe\'lu\'bogh video mojmoHbogh mIwmey. Media \'oHbe\'.',
        },
        bullets: {
          en: ['When to use Studio vs Media', 'Engine cards and remedies', 'Hyperframes and Video Use', 'Output in Documents'],
          hu: ['Stúdió vs Média', 'Motorkártyák és orvosságok', 'Hyperframes és Video Use', 'Kimenet a Dokumentumokban'],
          de: ['Studio vs Media', 'Engine-Karten und Remedies', 'Hyperframes und Video Use', 'Ausgabe in Dokumenten'],
          es: ['Estudio vs Media', 'Tarjetas de motor y remedios', 'Hyperframes y Video Use', 'Salida en Documentos'],
          fr: ['Studio vs Media', 'Cartes moteur et remèdes', 'Hyperframes et Video Use', 'Sortie dans Documents'],
          tlh: ['mIw pa\' Media je', 'mIw De\' \'ej QaH', 'Hyperframes Video Use je', 'ghItlhDaq nay\''],
        },
      },
      {
        slug: 'studio/hyperframes',
        titles: { en: 'Hyperframes', hu: 'Hyperframes', de: 'Hyperframes', es: 'Hyperframes', fr: 'Hyperframes', tlh: 'Hyperframes' },
        descriptions: {
          en: 'Write HTML compositions and render deterministic MP4s through Studio.',
          hu: 'HTML-kompozíciók, determinisztikus MP4 a Stúdión keresztül.',
          de: 'HTML-Kompositionen als deterministisches MP4 über Studio.',
          es: 'Composiciones HTML a MP4 determinista en Estudio.',
          fr: 'Compositions HTML rendues en MP4 déterministe via Studio.',
          tlh: 'HTML qonlu\', MP4 rap mIw pa\' lo\'.',
        },
        bullets: {
          en: ['Requirements', 'Agent tools', 'Composition contract', 'Never --no-sandbox'],
          hu: ['Követelmények', 'Ügynök toolok', 'Kompozíciós szerződés', 'Soha --no-sandbox'],
          de: ['Anforderungen', 'Agent-Tools', 'Kompositionsvertrag', 'Nie --no-sandbox'],
          es: ['Requisitos', 'Herramientas de agente', 'Contrato de composición', 'Nunca --no-sandbox'],
          fr: ['Prérequis', 'Outils agent', 'Contrat de composition', 'Jamais --no-sandbox'],
          tlh: ['poQbogh De\'', 'ghoqwI\' jan', 'qon chut', '--no-sandbox lo\'Qo\''],
        },
      },
      {
        slug: 'studio/videouse',
        titles: { en: 'Video Use', hu: 'Video Use', de: 'Video Use', es: 'Video Use', fr: 'Video Use', tlh: 'Video Use' },
        descriptions: {
          en: 'Cut raw footage to MP4 through Studio. Transcript-first. Not Media.',
          hu: 'Nyers felvétel vágása MP4-re a Stúdión keresztül. Először a transzkript. Nem a Média.',
          de: 'Rohmaterial in Studio zu MP4 schneiden. Transkript zuerst. Nicht Media.',
          es: 'Cortar metraje a MP4 en Estudio. Primero la transcripción. No es Media.',
          fr: 'Couper des rushes en MP4 dans Studio. Transcription d’abord. Pas Media.',
          tlh: 'video pe\'lu\' MP4. Qum wa\'DIch. Media \'oHbe\'.',
        },
        bullets: {
          en: ['Ingest and inventory', 'Transcribe and pack', 'Confirm strategy then EDL', 'Render with FFmpeg'],
          hu: ['Ingest és inventory', 'Transcribe és pack', 'Stratégia, aztán EDL', 'Render FFmpeg-gel'],
          de: ['Ingest und Inventar', 'Transcribe und Pack', 'Strategie dann EDL', 'Render mit FFmpeg'],
          es: ['Ingest e inventario', 'Transcribe y pack', 'Estrategia luego EDL', 'Render con FFmpeg'],
          fr: ['Ingest et inventaire', 'Transcribe et pack', 'Stratégie puis EDL', 'Rendu FFmpeg'],
          tlh: ['chel \'ej tetlh', 'Qum \'ej pa\'', 'mIw \'ej EDL', 'FFmpeg chenmoH'],
        },
      },
    ],
  },
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        descriptions: {
          en: 'Magnific, Higgsfield, and fal — one tool set, your backends.',
          hu: 'Magnific, Higgsfield és fal — egy toolkészlet, te választod a backendet.',
          de: 'Magnific, Higgsfield und fal — ein Tool-Satz, deine Backends.',
          es: 'Magnific, Higgsfield y fal — un juego de tools, tú eliges el backend.',
          fr: 'Magnific, Higgsfield et fal — un jeu d’outils, vos backends.',
          tlh: 'Magnific, Higgsfield, fal — wa\' jan, nIH Hol.',
        },
        bullets: {
          en: ['Connect a backend', 'Which backend?', 'Five tools', 'Routing and budget'],
          hu: ['Backend csatlakoztatása', 'Melyik backend?', 'Öt tool', 'Útválasztás és keret'],
          de: ['Backend verbinden', 'Welches Backend?', 'Fünf Tools', 'Routing und Budget'],
          es: ['Conectar un backend', '¿Qué backend?', 'Cinco tools', 'Enrutamiento y presupuesto'],
          fr: ['Connecter un backend', 'Quel backend ?', 'Cinq outils', 'Routage et budget'],
          tlh: ['nIH rar', '\'ar nIH', 'vagh jan', 'He Huch je'],
        },
      },
      {
        slug: 'ai/mcp',
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        descriptions: {
          en: 'Who gets told, on which channel, and how loudly — in-app, email, Telegram, webhook.',
          hu: 'Kit értesít, melyik csatornán, milyen hangerőn — alkalmazáson belül, email, Telegram, webhook.',
          de: 'Wen, über welchen Kanal, wie laut — In-App, E-Mail, Telegram, Webhook.',
          es: 'A quién avisar, por qué canal y con qué umbral — en la app, email, Telegram, webhook.',
          fr: 'Qui est prévenu, sur quel canal, à quel seuil — dans l’app, e-mail, Telegram, webhook.',
          tlh: '\'IvvaD QIn, \'ar He, \'ar wab — UI, QIn, Telegram, webhook.',
        },
        bullets: {
          en: ['Event patterns', 'Channels (web, email, Telegram, webhook)', 'Severity and quiet hours', 'Batching and retries'],
          hu: ['Eseményminták', 'Csatornák (web, email, Telegram, webhook)', 'Súlyosság és csendes órák', 'Kötegelés és újrapróbálás'],
          de: ['Ereignismuster', 'Kanäle (Web, E-Mail, Telegram, Webhook)', 'Schweregrad und Ruhezeiten', 'Bündeln und Wiederholen'],
          es: ['Patrones de evento', 'Canales (web, email, Telegram, webhook)', 'Severidad y horas quietas', 'Lotes y reintentos'],
          fr: ['Motifs d’événement', 'Canaux (web, e-mail, Telegram, webhook)', 'Sévérité et heures calmes', 'Regroupement et relances'],
          tlh: ['wanI\' Deghmey', 'Hemey (web, QIn, Telegram, webhook)', 'tlhuH \'ej jim repmey', 'ghomqa\' \'ej nIDqa\''],
        },
      },
      {
        ...
        descriptions: {
          en: 'Install, enable, and review third-party skill packs without leaving MIT-compatible licenses.',
          hu: 'Harmadik féltől származó skill-csomagok telepítése és engedélyezése — csak MIT-kompatibilis licencek.',
          de: 'Skill-Pakete Dritter installieren und aktivieren — nur MIT-kompatible Lizenzen.',
          es: 'Instalar y activar paquetes de skills de terceros — solo licencias compatibles con MIT.',
          fr: 'Installer et activer des packs de compétences tiers — licences compatibles MIT uniquement.',
          tlh: 'latlh laH pa\'mey lIng \'ej QapmoH — MIT chaw\' neH.',
        },
        bullets: {
          en: ['Catalogue and license check', 'Install / enable / disable', 'Skills the pack adds', 'When not to install'],
          hu: ['Katalógus és licenc-ellenőrzés', 'Telepítés / be / ki', 'A csomag skillei', 'Mikor ne telepíts'],
          de: ['Katalog und Lizenzprüfung', 'Installieren / ein / aus', 'Skills des Pakets', 'Wann nicht installieren'],
          es: ['Catálogo y licencia', 'Instalar / activar / desactivar', 'Skills que añade el paquete', 'Cuándo no instalar'],
          fr: ['Catalogue et licence', 'Installer / activer / désactiver', 'Compétences ajoutées', 'Quand ne pas installer'],
          tlh: ['tetlh chaw\' chov je', 'lIng / Qap / QapHa\'', 'pa\' chel laHmey', 'lIngQo\' poH'],
        },
      },
      {
        slug: 'admin/nodes',
        ...
        descriptions: {
          en: 'Other machines EYAS can reach (SSH and friends) so agents can run work off this box.',
          hu: 'Más gépek, amiket az EYAS elér (SSH és társai), hogy az ágensek ne csak ezen a dobozon dolgozzanak.',
          de: 'Andere Rechner, die EYAS erreicht (SSH und Verwandte), damit Agenten Arbeit auslagern.',
          es: 'Otras máquinas a las que EYAS llega (SSH y similares) para ejecutar trabajo fuera de esta caja.',
          fr: 'Autres machines joignables par EYAS (SSH et apparentés) pour exécuter du travail hors de cette machine.',
          tlh: 'latlh janmey EYAS SIchlaH (SSH juppu\' je) — ghoqwI\'pu\' janvamDaq vumbe\'.',
        },
        bullets: {
          en: ['Add a node (name, host, type)', 'Capabilities and health', 'When agents use a node', 'Remove a node'],
          hu: ['Node hozzáadása (név, host, típus)', 'Képességek és állapot', 'Mikor használja az ágens', 'Node törlése'],
          de: ['Node hinzufügen (Name, Host, Typ)', 'Fähigkeiten und Status', 'Wann Agenten den Node nutzen', 'Node entfernen'],
          es: ['Añadir nodo (nombre, host, tipo)', 'Capacidades y salud', 'Cuándo lo usa un agente', 'Quitar un nodo'],
          fr: ['Ajouter un nœud (nom, hôte, type)', 'Capacités et santé', 'Quand un agent l’utilise', 'Supprimer un nœud'],
          tlh: ['Node chel (pong, jan, Segh)', 'laHmey yIn je', 'ghoqwI\' lo\'meH poH', 'Node teq'],
        },
      },
      {
        slug: 'admin/hands',
        ...
        descriptions: {
          en: 'Pair a local “hand” so EYAS can use CLIs and desktop automation on a machine you control.',
          hu: 'Párosíts egy helyi „kezet”, hogy az EYAS CLI-ket és asztali automatizálást használjon egy általad kontrollált gépen.',
          de: 'Eine lokale „Hand“ koppeln, damit EYAS CLIs und Desktop-Automation auf einem von dir kontrollierten Rechner nutzt.',
          es: 'Empareja una «mano» local para que EYAS use CLIs y automatización de escritorio en una máquina tuya.',
          fr: 'Apparier une « main » locale pour qu’EYAS utilise des CLI et l’automatisation bureau sur une machine que vous contrôlez.',
          tlh: 'juH ghop yIrar — EYAS CLI, Desktop SeH je lo\'laH SoH janDaq.',
        },
        bullets: {
          en: ['Pairing code', 'Connected hands and capabilities', 'Discovered CLI / app tools', 'Disconnect'],
          hu: ['Párosító kód', 'Csatlakozott kezek és képességek', 'Felfedezett CLI / app toolok', 'Leválasztás'],
          de: ['Kopplungscode', 'Verbundene Hands und Fähigkeiten', 'Gefundene CLI-/App-Tools', 'Trennen'],
          es: ['Código de emparejado', 'Manos conectadas y capacidades', 'Tools CLI / app descubiertas', 'Desconectar'],
          fr: ['Code d’appariement', 'Mains connectées et capacités', 'Outils CLI / app découverts', 'Déconnecter'],
          tlh: ['rar ngoq', 'rarbogh ghopmey laHmey je', 'tu\'lu\'bogh CLI / app janmey', 'rarHa\''],
        },
      },
      {
        slug: 'admin/backup',
      ...
      },
      {
        ...
        descriptions: {
          en: 'Metrics, traces, quality scores, and the ops console for a running instance.',
          hu: 'Metrikák, trace-ek, minőségi pontszámok és az ops konzol a futó példányhoz.',
          de: 'Metriken, Traces, Qualitätsscores und die Ops-Konsole der laufenden Instanz.',
          es: 'Métricas, trazas, puntuaciones de calidad y la consola ops de la instancia en marcha.',
          fr: 'Métriques, traces, scores de qualité et console ops de l’instance en cours.',
          tlh: 'mI\'mey, tlha\'mey, QaQ mI\'mey, \'ej QaptaHbogh pat ops console.',
        },
        bullets: {
          en: ['Observability UI', 'Context traces', 'Ops page and runbooks', 'System update'],
          hu: ['Observability UI', 'Kontextus-trace-ek', 'Ops oldal és runbookok', 'Rendszerfrissítés'],
          de: ['Observability-UI', 'Kontext-Traces', 'Ops-Seite und Runbooks', 'System-Update'],
          es: ['UI de observabilidad', 'Trazas de contexto', 'Página ops y runbooks', 'Actualización del sistema'],
          fr: ['Interface d’observabilité', 'Traces de contexte', 'Page ops et runbooks', 'Mise à jour système'],
          tlh: ['bejlaH UI', 'De\' tlha\'mey', 'ops ghItlh runbookmey je', 'pat chu\'qa\''],
        },
      },
    ],
  },
...
function writePage(locale, page, sectionLabel) {
  const indexRel = page.slug === 'index' ? 'index.md' : join(page.slug, 'index.md')
  const fileRel = page.slug === 'index' ? 'index.md' : `${page.slug}.md`
  const indexPath = join(contentRoot, locale, indexRel)
  const filePath = join(contentRoot, locale, fileRel)
  // Starlight section overviews live at slug/index.md; skip those instead of writing slug.md beside them.
  const path = existsSync(indexPath) ? indexPath : filePath
  ...
  if (existsSync(path)) {
    ...
    if (!existing.includes(MARKER) && (page.slug === 'agents/voice' || page.slug === 'getting-started' || page.slug === 'index' || page.slug === 'first-hour')) {
...
${SECTIONS.reduce((n, s) => n + s.pages.length, 0)} pages × ${LOCALES.length} locales.
`
