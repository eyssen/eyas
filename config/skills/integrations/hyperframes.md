...
Use Studio, not Media. `media_generate` is hosted prompt→pixels (Magnific / Higgsfield / fal / HeyGen talking-head). Hyperframes is authored HTML → deterministic MP4 on this machine.
