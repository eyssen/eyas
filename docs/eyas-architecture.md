...
**Amit a rogzites meg nem tud:** semmi nem ir automatikusan. A vault ma
pontosan azt tartalmazza, amit szandekosan tettek bele. Az extraktor (
determinisztikus kapu + olcso modellhivas + dedup) kulon fazis; a `save_memory`
tool a kezi ut, valtozatlanul.
