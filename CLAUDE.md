...
## Current State
**0.8.11-beta** — Conversation working folders + auto-title; Grok CLI cwd and $2/$6 pricing; French + Klingon UI and handbook; durable Cloudflare tunnel; incremental batched code indexer. See `CHANGELOG.md`.
