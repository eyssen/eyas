...
## Current State
**0.8.13-beta** — What actually happened: per-turn context composition inspector, skill inventory + dead-skill detector (disables, never deletes), scheduler runnability and a complete execution log. See `CHANGELOG.md`.
