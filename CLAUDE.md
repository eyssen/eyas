...
## Current State
**0.8.10-beta** — French + Klingon (tlhIngan Hol) UI and handbook; durable Cloudflare tunnel + pasted S3/B2 backup credentials; incremental batched code indexer; 40+ modules. See `CHANGELOG.md`.
