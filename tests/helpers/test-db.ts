...
export function createTestDb(_label: string) {
  function open() {
    ...
    db.run(sql`CREATE TABLE IF NOT EXISTS projects (id TEXT PRIMARY KEY, name TEXT NOT NULL, description TEXT, type_id TEXT, prompt TEXT, indexed_sources TEXT, skills TEXT, permissions TEXT, color TEXT, sort_order INTEGER NOT NULL DEFAULT 0, default_agent_id TEXT, source TEXT NOT NULL DEFAULT 'user', created_at TEXT NOT NULL, updated_at TEXT NOT NULL)`)
