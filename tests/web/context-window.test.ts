...
describe('resolveContextWindow', () => {
  ...
  it('a CLI model with a 1M catalog window uses 1M, not the 200k provider window (G11)', () => {
    expect(resolveContextWindow(1_000_000, 'claude-code')).toBe(1_000_000)
    expect(resolveContextWindow(null, 'claude-code')).toBe(200_000)
  })
