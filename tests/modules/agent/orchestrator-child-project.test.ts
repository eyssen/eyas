...
function conversationsTable(db: any) {
  db.run(sql`CREATE TABLE conversations (
    ...
    provider_id TEXT, model_id TEXT, model_user_chosen INTEGER NOT NULL DEFAULT 0, model_binding TEXT NOT NULL DEFAULT 'pinned', user_id TEXT NOT NULL, tokens_used INTEGER NOT NULL DEFAULT 0,
