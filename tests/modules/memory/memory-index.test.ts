...
describe('project-ranked recall (F1)', () => {
  ...
  it('a project note with no declared project id never ranks', () => {
    note2('projects/team-sessions/x.md', 'project', 'Orphan project note', null)
...
describe('type-ranked recall (item 20)', () => {
  ...
  it('a domain note with no type id never ranks', () => {
    note3('project-types/type-a/orphan.md', 'domain', 'Orphan type note', null, null)
    expect(buildMemoryIndex(db, { projectId: 'alpha', projectTypeId: 'type-a' })).toBeNull()
  })
