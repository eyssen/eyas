...
describe('buildAgentProposals', () => {
  it('proposes tier-appropriate concrete models per agent', () => {
    ...
    expect(out).toEqual([
      { id: 'a1', name: 'Reviewer', agentType: 'reviewer', proposedTier: 'opus', proposedProviderId: 'claude-code', proposedModelId: 'claude-code-opus' },
      { id: 'a2', name: 'Helper', agentType: 'assistant', proposedTier: 'sonnet', proposedProviderId: 'claude-code', proposedModelId: 'claude-code-sonnet' },
      { id: 'a3', name: 'Monitor', agentType: 'observer', proposedTier: 'haiku', proposedProviderId: 'claude-code', proposedModelId: 'claude-code-haiku' },
    ])
  })
  it('leaves proposedModelId null when no provider available', () => {
    ...
    expect(out[0].proposedProviderId).toBeNull()
  })
})
