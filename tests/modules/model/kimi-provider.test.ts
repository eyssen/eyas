...
describe('Kimi Code CLI provider', () => {
  ...
  it('starts the ACP session in the conversation working directory', async () => {
    const seen: string[] = []
    ...
    const p = createKimiCliProvider({ cwd: '/Users/eyssen/GitHub/eyas', runPrompt: fakeRun as any })
