    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 mt-2 w-64 z-50 bg-popover text-popover-foreground border border-border rounded-lg shadow-lg overflow-hidden p-1.5" role="menu">
            {TEMPLATES.map((tpl) => (
              <button
                key={tpl.id}
                role="menuitemradio"
