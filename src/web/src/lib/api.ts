export class ApiError extends Error {
  /**
   * `code`: the machine-readable code from the error body, when the server sent
   * one (map it to t()). `details`: the whole error body, for the parameters a
   * translated message needs (e.g. the refused folder's `path`).
   */
