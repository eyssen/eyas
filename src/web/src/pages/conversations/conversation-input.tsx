...
import { ArrowUp, Paperclip, Loader2, X, FileText, Wand2 } from 'lucide-react'
...
export function ConversationInput({ onSend, disabled, conversationId }: ConversationInputProps) {
  ...
  }, [value, disabled, isUploading, attachments, onSend])
  ...
  return (
    <div
      ref={dropRef}
      className={`border-t p-3 ${isDragging ? 'bg-primary/5 border-primary/30' : ''}`}
