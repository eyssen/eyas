...
import { useOpencodeAccess } from '@/pages/opencode/access'
...
interface ConversationTopBarProps {
  ...
  /** The OpenCode terminal toggle; shown only to a user the server lets open terminals (manage OpenCode). */
...
export function ConversationTopBar({
  ...
  // A terminal is effectively a shell on the server: the owner's and an
  // admin's by default. The server's CASL answer decides, never the role name.
  const opencodeAccess = useOpencodeAccess()
  ...
  return (
    <div className="flex-shrink-0">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-border/50">
        ...
        {onToggleTerminal && opencodeAccess.terminal && (
          <Button
