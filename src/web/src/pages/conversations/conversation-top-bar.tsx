...
import { ArrowLeft, Pencil, Check, Bot, SquareTerminal } from 'lucide-react'
  ...
  return (
    <div className="flex-shrink-0">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-border/50">
        ...
        {providerId && (
          <span
            className={cn('text-[10px] text-muted-foreground font-mono', godMode && 'opacity-50')}
            title={godMode ? t('conversations.godMode.topBarMuted') : undefined}
          >
        ...
        {!providerId && (
          <span
            className={cn('text-[10px] text-muted-foreground', godMode && 'opacity-50')}
            title={godMode ? t('conversations.godMode.topBarMuted') : undefined}
          >
            {t('conversations.topBar.autoRouting')}
          </span>
        )}
      </div>
    </div>
