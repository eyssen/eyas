...
import { Moon, Sun, Bot, LayoutDashboard, KeyRound, Users, Building2 } from 'lucide-react'
import { TEMPLATES } from '@/themes/registry'
import ModelAssignmentsCard from './model-assignments-card'
import GodModeCard from './god-mode-card'
            ...
            <div className="flex flex-col gap-2">
              {providers.map((p) => (
                <div key={p.id} className="flex items-center gap-3 p-2 rounded-lg bg-accent/30">
                  ...
                  <span className="text-sm flex-1">{p.name || p.id}</span>
