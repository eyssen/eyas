...
import { isUnsandboxedShellReason } from '../../../../shared/cli-sandbox'
...
function ApprovalSummary({ approval: a }: { approval: Approval }) {
  return (
    <div className="min-w-0">
      ...
      {isUnsandboxedShellReason(a.reason) && (
        <div className="text-xs text-foreground">{t('autonomy.reason.unsandboxedShell')}</div>
      )}
