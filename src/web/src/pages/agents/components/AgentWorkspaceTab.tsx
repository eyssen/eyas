  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        {/* MEMORY.md is the owner's own note file: never sent to the model and
            not writable by agents (core rule 8). */}
        {selectedFile === 'MEMORY.md' && (
          <p className="text-xs text-muted-foreground">{t('agents.workspaceTab.file.memoryHint')}</p>
        )}
      </div>
