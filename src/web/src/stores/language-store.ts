...
export type Lang = 'en' | 'hu' | 'de' | 'es'

// The languages the app offers. English is the source; hu/de/es are translation
// layers. Per project policy every new field/label ships in all four — but a
...
export const SUPPORTED_LANGS: Lang[] = ['en', 'hu', 'de', 'es']
export const LANG_LABELS: Record<Lang, string> = { en: 'English', hu: 'Magyar', de: 'Deutsch', es: 'Español' }
export const LANG_SHORT: Record<Lang, string> = { en: 'EN', hu: 'HU', de: 'DE', es: 'ES' }

function isLang(v: string | null | undefined): v is Lang {
  return v === 'en' || v === 'hu' || v === 'de' || v === 'es'
}
