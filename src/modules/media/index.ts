...
// fal / HeyGen) register themselves onto ctx.media; none is default. Zero
// providers is a valid, fail-closed empty state.
...
import { heygenManifest } from './submodules/heygen/manifest.js'
...
export const mediaModule: EyasModule = {
  ...
  type: 'core',
  required: false,
  description: 'Vendor-neutral media generation gateway (Magnific, Higgsfield, fal, HeyGen)',
  dependencies: ['secrets', 'tools'],
  optional: ['documents', 'conversations', 'communication', 'audit'],
  submodules: [magnificManifest, higgsfieldManifest, falManifest, heygenManifest],
