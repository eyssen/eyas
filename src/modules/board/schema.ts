...
export const projects = sqliteTable('projects', {
  ...
  ticketConnectionId: text('ticket_connection_id'),
  wikiAutoTickets: integer('wiki_auto_tickets').notNull().default(0),
  wikiAutoDecisions: integer('wiki_auto_decisions').notNull().default(0),
  wikiTicketBody: text('wiki_ticket_body').notNull().default('title'),
  createdAt: text('created_at').notNull(),
