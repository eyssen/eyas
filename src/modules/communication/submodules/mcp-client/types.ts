...
/** MCP server connection status ('blocked' = a memory store EYAS never runs, see memory-store.ts) */
export type McpServerStatus = 'connected' | 'disconnected' | 'error' | 'connecting' | 'blocked'
