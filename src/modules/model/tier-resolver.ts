...
const PROVIDER_TIER_MODEL: Record<string, Record<ModelTier, string>> = {
  ...
  // Kimi Code CLI: its models are known only after discovery, so every tier is the CLI's own default.
  'kimi-cli': { opus: 'kimi-cli-default', sonnet: 'kimi-cli-default', haiku: 'kimi-cli-default' },
  anthropic: { opus: 'claude-opus-4-8', sonnet: 'claude-sonnet-4-6', haiku: 'claude-haiku-4-5' },
  kimi: { opus: 'kimi-k3', sonnet: 'kimi-k2.7-code', haiku: 'kimi-k2.6' },
}
