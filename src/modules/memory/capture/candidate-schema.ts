 ...
 * its siblings.
 */
export function createCandidateSchema(opts: { allowProject: boolean; allowDomain?: boolean }) {
  return base
    .refine(
...
export function createCandidateBatchSchema(opts: { allowProject: boolean; allowDomain?: boolean }) {
