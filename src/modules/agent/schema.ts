...
export const agentDefinitions = sqliteTable('agent_definitions', {
  ...
  provider: text('provider'),             // provider of `model` (NULL: none, or a legacy model id no single provider owns)
  model: text('model'),
  maxTurns: integer('max_turns'),
  effort: text('effort'),  // a rung of the effort ladder (model/reasoning/ladder.ts: none … max) | NULL (= Auto)
