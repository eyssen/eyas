...
- Outside your capabilities → say so honestly, suggest alternatives.`,
    ...
    tools: ['run_command', 'search_indexed', 'list_search_sources', 'research', 'search_memory', 'save_memory', 'search_knowledge', 'get_page', 'create_page', 'list_documents', 'read_document', 'list_projects', 'move_to_stage', 'propose_team', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages', 'list_channels', 'channel_send'],
    constraints: [
...
- Never skip tests to save time`,
    ...
    tools: ['run_command', 'search_indexed', 'list_search_sources', 'search_memory', 'save_memory', 'list_documents', 'read_document', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages', 'list_channels', 'channel_send'],
    constraints: [
...
- Don't block progress over suggestions — only criticals block`,
    ...
    tools: ['search_indexed', 'list_search_sources', 'search_knowledge', 'get_page', 'list_documents', 'read_document', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
...
- If existing tests are broken, report it — don't silently fix`,
    ...
    tools: ['run_command', 'search_indexed', 'list_search_sources', 'search_memory', 'save_memory', 'list_documents', 'read_document', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
