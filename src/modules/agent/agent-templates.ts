...
- Outside your capabilities → say so honestly, suggest alternatives.`,
    ...
    tools: ['run_command', 'read_file', 'write_file', 'edit_file', 'grep', 'glob', 'git_status', 'git_diff', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'research', 'memory_search', 'memory_expand', 'search_knowledge', 'get_page', 'create_page', 'list_documents', 'read_document', 'list_projects', 'move_to_stage', 'propose_team', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages', 'list_channels', 'channel_send', 'design_list', 'design_read', 'design_create', 'design_write', 'design_link', 'design_unlink', 'render_html_document'],
    constraints: [
...
- Never skip tests to save time`,
    ...
    tools: ['run_command', 'read_file', 'write_file', 'edit_file', 'grep', 'glob', 'git_status', 'git_diff', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'memory_search', 'memory_expand', 'list_documents', 'read_document', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages', 'list_channels', 'channel_send'],
    constraints: [
...
- Don't block progress over suggestions — only criticals block`,
    ...
    tools: ['read_file', 'grep', 'glob', 'git_status', 'git_diff', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_knowledge', 'get_page', 'list_documents', 'read_document', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
...
- If existing tests are broken, report it — don't silently fix`,
    ...
    tools: ['run_command', 'read_file', 'write_file', 'edit_file', 'grep', 'glob', 'git_status', 'git_diff', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'memory_search', 'memory_expand', 'list_documents', 'read_document', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
...
- Update existing docs rather than creating new ones when possible`,
    ...
    tools: ['search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_knowledge', 'get_page', 'create_page', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages', 'design_list', 'design_read', 'render_html_document'],
    constraints: [
...
- Document all error cases`,
    ...
    tools: ['read_file', 'grep', 'glob', 'git_status', 'git_diff', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_knowledge', 'get_page', 'list_documents', 'read_document', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages', 'design_list', 'design_read', 'render_html_document'],
    constraints: [
...
- Ask clarifying questions before writing stories for ambiguous requests`,
    ...
    tools: ['search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_knowledge', 'get_page', 'list_documents', 'read_document', 'memory_search', 'memory_expand', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
...
- Don't mix opinion with facts — label each clearly`,
    capabilities: ['research', 'code-analysis'],
    tools: ['research', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'memory_search', 'memory_expand', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
      'Always cite sources',
