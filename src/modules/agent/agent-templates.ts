...
- Update existing docs rather than creating new ones when possible`,
    ...
    tools: ['search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_knowledge', 'get_page', 'create_page', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
