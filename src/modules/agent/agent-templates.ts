...
- Use memory (search_memory) for preferences and prior decisions.
...
- Never skip tests to save time`,
    ...
    tools: ['run_command', 'read_file', 'write_file', 'edit_file', 'grep', 'glob', 'git_status', 'git_diff', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_memory', 'save_memory', 'list_documents', 'read_document', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages', 'list_channels', 'channel_send'],
    constraints: [
...
- If existing tests are broken, report it — don't silently fix`,
    ...
    tools: ['run_command', 'read_file', 'write_file', 'edit_file', 'grep', 'glob', 'git_status', 'git_diff', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_memory', 'save_memory', 'list_documents', 'read_document', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
...
- Ask clarifying questions before writing stories for ambiguous requests`,
    ...
    tools: ['search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_knowledge', 'get_page', 'list_documents', 'read_document', 'search_memory', 'save_memory', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
...
- Don't mix opinion with facts — label each clearly`,
    capabilities: ['research', 'code-analysis'],
    tools: ['research', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_memory', 'save_memory', 'delegate_to_agent', 'write_team_memory', 'read_team_memory', 'send_agent_message', 'read_agent_messages'],
    constraints: [
      'Always cite sources',
