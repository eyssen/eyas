...
export const agentModule: EyasModule = {
  ...
  async onRegister(ctx: ModuleContext) {
    ...
    ;(ctx as any).agents = { registry, runner, messaging, orchestrator, teamSessions: teamSessionService, delegation, supervisor, getCheckpoint: getCheckpointServices, executeAgent, critic: criticDeps, budgetEngine, orchestrationOwnership }
