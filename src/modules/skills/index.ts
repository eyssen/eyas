...
export const skillsModule: EyasModule = {
  ...
  async onStart(ctx: ModuleContext) {
    ...
    // Extra instance roots (local.yaml). Imported files win on id collision
    // without flipping Claude settingSources — isolation stays on.
    const importRoots = resolveSkillImportRoots(ctx.config)
