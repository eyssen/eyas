 ...
 *
 * Autonomous OCI OKE operator: observes cluster + application telemetry,
...
> = {
  ...
  required: false,
  description:
    'Autonomous OCI OKE operator. Observe → diagnose → propose → approve → apply. GitOps-first, signed-metrics gated.',
  dependencies: [],
