...
export const DEFAULT_CONFIG: SecurityGateConfig = {
  ...
  riskTiers: {
    green: [
      'search_memory', 'search_indexed', 'list_search_sources', 'get_search_context', 'set_search_context', 'search_knowledge', 'get_page', 'list_documents', 'read_document', 'list_projects', 'get_conversation_status',
