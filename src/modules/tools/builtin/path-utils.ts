...
export function resolveToolPath(
  ...
  // Symlink-aware jail: judge where the path really lands, including a new
  // file under a symlinked folder or a dangling link.
  let resolved: string
  try {
    resolved = realpathBestEffort(candidate)
  } catch {
