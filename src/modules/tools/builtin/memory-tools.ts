  ...
  return [
    {
      name: 'search_memory',
      description:
        'Search episodic, vault, and prior conversation messages for relevant context. ' +
        'Default scope is the current project, its type, and global user/feedback/reference notes. ' +
        'Pass scope=all to include other projects. The current conversation is excluded.',
      category: 'memory',
      riskTier: 'green',
      inputSchema: {
        type: 'object',
        properties: {
          ...
          tier: {
            ...
            enum: ['episodic', 'semantic', 'procedural', 'archive', 'conversation'],
