...
// comes through EYAS. So instead: every conversation has a directory (its own
// EYAS workspace, model/cli-runtime/workspaces.ts, when it names no Folders),
// and after a turn this looks in it for what appeared.
//
