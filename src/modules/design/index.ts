...
import { createDesignCompletion } from './design-ai.js'
...
export const designModule: EyasModule = {
  ...
  async onStart(ctx: ModuleContext) {
    ...
    // Plain text completion — every provider can do it — as one isolated
    // call on the install default (design-ai.ts createDesignCompletion).
    const complete = createDesignCompletion(() => ctx.model)
