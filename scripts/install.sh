...
#                      (e.g. --version 0.8.3-beta or --version v0.8.3-beta)
#   --help
#
...
EYAS_LOGO="${CYAN}${BOLD}
  ...
  ███████╗   ██║   ██║  ██║███████║
  ╚══════╝   ╚═╝   ╚═╝  ╚═╝╚══════╝
${NC}${DIM}  eYssen EYAS Installer — v0.8.3-beta${NC}
"
...
# 0.8.3-beta → v0.8.3-beta; v0.8.3-beta / main / feature-x left as-is.
normalize_git_ref() {
  local ref="$1"
  if [[ -z "$ref" ]]; then
    echo "main"
...
Options:
  ...
  --version TAG          Git tag or branch (default: main)
                         Match a backup: --version 0.8.3-beta
                         (also: EYAS_VERSION=0.8.3-beta)
  --help                 Show this help
