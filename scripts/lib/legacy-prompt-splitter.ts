...
import type { AIProvider, ContentBlock } from '../../src/modules/model/types.js'

/** The one provider call the split needs: the production AIProvider.complete(). */
export type SplitModel = Pick<AIProvider, 'complete'>
