...
```bash
curl -fsSL https://raw.githubusercontent.com/eyssen/eyas/main/scripts/install.sh | bash -s -- --version 0.8.19-beta
# or:  EYAS_VERSION=0.8.19-beta curl … | bash
```
...
**57 modules**, each independently toggleable and talking over one event bus:
...
- **7,200+ tests** across 747 test files
